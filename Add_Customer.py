...
#select_state = driver.find_element(By.XPATH, '')
#select_state.click()
...
check_add_to_promotional_list_box = driver.find_element(By.XPATH, '//*[@id="loginform"]/div/div/div/div/form/div[7]/input')
check_add_to_promotional_list_box.click()
